...
#        ~/Documents/PowerShell/git-prompt.ps1
...
#            $WD = $PWD.Path.Replace($HOME, '~')
#            "PS $UH $WD $(__git_ps1 -f '({0})')`n$NestedPromptLevel> "
#          }
...
#          function Prompt
#          {
#            $UH = "`e[0;33m$env:USERNAME@$env:COMPUTERNAME`e[m"
#            $WD = "`e[1;36m$($PWD.Path.Replace($HOME, '~'))`e[m"
#            __git_ps1 "PS $UH $WD" "`n$NestedPromptLevel> "
#          }
